class PhotoHeaderView < UIView
  ...
  def initWithFrame(frame, photo:photo)
    ...
    if super.initWithFrame(frame)
      ...
      containerView.setBackgroundColor UIColor.darkGrayColor #.colorWithAlphaComponent(0.9)

      profile_image_view = UIImageView.alloc.initWithFrame([[0,4],[45,45]])
      ...
      profile_button.frame = [[0,4],[45,45]]
      ...
      taken_by_label.font = UIFont.fontWithName("DIN-Bold", size:15)
      taken_by_label.textColor = UIColor.whiteColor
      ...
      taken_at_label.font = UIFont.fontWithName("DIN-Medium", size:12)
      taken_at_label.textColor = "#333333".to_color # UIColor.lightGrayColor
